...
message_2: .asciiz "Please Enter the length of the arr_asc -: "
message_3: .asciiz "Please Enter N integers In Ascending Order -: "
message_4: .asciiz "Please Enter the element that you want to search -: "
nLine: .asciiz "\n"	
...
right:      slt $t4,$t3,$a3	# if mid < key then right elese left will be executed 
      beq $t4,$0,left	
      addi $sp,$sp,-4
      sw $ra,0($sp)
